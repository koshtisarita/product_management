...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        ...
        <a class="underline text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('view-category')); ?>">
                    <?php echo e(__('View')); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                        <input id="cid" class="block mt-1 w-full" type="hidden" name="cid" value="<?php echo e($category->id); ?>" required />
                        <input id="name" class="block mt-1 w-full" type="text" name="name" value="<?php echo e($category->name); ?>" required/>
                    </div>
                    <!-- Image -->
                    <div class="mt-4">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                    ...
                    <div class="mt-4">
                        <img src="<?php echo e($category->image); ?>" width='60' height="60">
                    </div>
...
<?php endif; ?><?php /**PATH F:\simplifies_solution\resources\views/edit_category.blade.php ENDPATH**/ ?>